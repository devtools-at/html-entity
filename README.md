...
Html Entity - Free online developer tool

## Online Tool

Use this tool online at **[DevTools.at](https://devtools.at/tools/html-entity)** - Free, fast, and no registration required!
...
```bash
npm install @devtools-at/html-entity
```

### Usage

```javascript
import { process, encode, decode } from '@devtools-at/html-entity';
...
**[https://devtools.at/tools/html-entity](https://devtools.at/tools/html-entity)**
...
- [npm Package](https://www.npmjs.com/package/@devtools-at/html-entity)
